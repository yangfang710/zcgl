package com.cqupt.sysManage.dao;
...
public class PermissiondomDao {
	...
	public String createPopedomTree() throws CquptException {
		...
		try {
			...
			String sql = "select t.menuid ELEMENT_ID,t.menuname ELEMENT_NAME,t.url ELEMENT_URL,t.menulevel ELEMENT_GRADE ,t.p_menuid P_ELEMENT_ID,t.menu_title ELEMENT_TITLE,t.menu_desc ELEMENT_DESC,t.menu_order ELEMENT_ORDER  from sys_menu t ORDER BY t.menulevel,t.menu_order ";
	...
	public List showPopedom(String elementId) throws CquptException {
		...
		try {
			session = DataStormSession.getInstance();
			String sql = "select t.menuid ELEMENT_ID,t.menuname ELEMENT_NAME,t.url ELEMENT_URL,t.menulevel ELEMENT_GRADE ,t.p_menuid P_ELEMENT_ID,t.menu_title ELEMENT_TITLE,t.menu_desc ELEMENT_DESC,t.menu_order ELEMENT_ORDER  from sys_menu t where menuid='"+elementId+"'";
