...
public class OnLineUserAction extends ActionSupport{
	...
	private String getOnLineUserData(String page,String pagesize){
        ...
        for (Iterator it = key.iterator(); it.hasNext();) {
            ...
            logger.info("在线用户数："+onlineUserCount);
            logger.info((Integer.parseInt(page)-1)*Integer.parseInt(pagesize)+1);
            logger.info(Integer.parseInt(page)*Integer.parseInt(pagesize));
