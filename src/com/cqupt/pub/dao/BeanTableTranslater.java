...
public class BeanTableTranslater {
     ...
     */
    protected List<Map<String, Object>> populate(Object result) throws CquptException {
     ...
     * @return Object
     */
    protected List<Object> populate(Class<?> clazz, Object result) throws CquptException {
