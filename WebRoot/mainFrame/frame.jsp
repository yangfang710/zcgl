...
$(function() {
	...
	$('#loginOut').click(function() {
		$.messager.confirm('系统提示', '您确定要退出本次登录吗?', function(r) {
			...
			if (r) {
				...
				xhr1.onreadystatechange = function() {
					location.href = '../zcgl';	//点击安全退出，回到登录页面
				}
	...
	<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
		...
		<!-- 上面部分 -->
		<div region="north" split="true" border="false"	 style="overflow: hidden; height: 50px; background: url('mainFrame/images/top.jpg')  repeat-x 100% bottom; line-height: 20px; color: #fff; font-family: Verdana, 微软雅黑, 黑体">
			
			<span style="float: right; padding-right: 20px;" align="absmiddle"	class="head">欢迎<userName:userName></userName:userName>登录
				<a href="#" id="editpass" style="text-decoration:none;color:red;font-size:16px"><strong>修改密码</strong></a> 
				<a href="#" id="loginOut" style="text-decoration:none;color:red;font-size:16px"><strong>安全退出</strong></a> 
				<%-- <a href="#" id="help">帮助</a>  --%>
			</span>		
			<span style="padding-top:20px;padding-left: 60px; font-size: 20px;vertical-align: top;line-height:31px;position:relative;background:url(mainFrame/images/login_header_modify_3.png) no-repeat left center;background-position:0px 16px;padding-bottom:10px;">通信学院  资产管理系统	
			 </span>
		</div>
		<!-- 下面部分 脚 -->
		<div region="south" split="true"
			style="height: 30px; background: #D6E3EF;">
			<div class="footer">
			</div>
		</div>
		<!-- 左边部分  用户菜单-->
