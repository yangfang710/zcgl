					...
					<tr>
						...
						<td class="l-table-edit-td">
							<input name="departmentName" type="text" id="departmentName"
								ltype="text" readonly="readonly" onfocus="this.blur()"
					...
					<tr>
						...
						<td class="l-table-edit-td">
							<input type="text" id="productCode" name="productCode"
								readonly="readonly"  value="${request.productCode }" onfocus="this.blur()" />
						</td>
					...
					<tr>
						...
						<td class="l-table-edit-td">
							<textarea style="height: 50px; width: 135px" id="address"
								name="address">${request.address }</textarea>
						</td>
					</tr>
					...
					<tr>
						...
						<td class="l-table-edit-td">
							<input type="text" id="receiveUser" name="receiveUser"
								validate="{required:true}" value="${request.receiveUser }" />
						</td>
...
function f_modify() {
	...
	$.ajax( {
		url : 'productUpdate?id=${request.id}', //后台处理程序   
		type : 'post', //数据发送方式   
